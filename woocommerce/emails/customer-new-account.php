...
<?php if ( 'yes' === get_option( 'woocommerce_registration_generate_password' ) && $password_generated && $set_password_url ) : ?>
	...
	<p><a href="<?php echo home_url().'?confirm='.base64_encode('encrypted-'.$email).'#reset_password';  ?>"><?php printf( esc_html__( 'Click here to set your new password.', 'woocommerce' ) ); ?></a></p>
<?php endif; ?>
